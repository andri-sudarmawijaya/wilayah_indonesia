...
class VilageViewsData extends EntityViewsData {
  ...
  public function getViewsData() {
    ...
    $data['wilayah_indonesia_vilage']['district'] = array(
	  ...
	  'relationship' => array(
	    ...
	    'relationship field' => 'district_id', // The name of the field on the joined table.
	    // 'relationship field' => 'tid',
	    // 'field' => 'optimo_package_id' -- see hook_views_data_alter(); not needed here.
	    'handler' => 'views_handler_relationship',
	    'label' => t('District'),
	    'title' => t('Relation to District Entity'),
	    'field' => [
